...
for cmd in lsblk findmnt wipefs sfdisk partprobe udevadm mkfs.vfat mkfs.btrfs btrfs bsdtar tar arch-chroot blkid install qemu-aarch64-static ansible-playbook; do
  need "$cmd"
done
